...
function AcceptableUsePolicy() {
    return (
        <main>
            ...
            <p>This policy was last reviewed on 20 March 2022.</p>
            ...
            <h3 id="customer-accountability">Customer accountability</h3>
            ...
            <h3 id="prohibited-activity">Prohibited activity</h3>
            <h4 id="copyright-infringement-and-access-to-unauthorized-material">Copyright infringement and access to unauthorized material</h4>
            ...
            <h4 id="spam-and-unauthorized-message-activity">SPAM and unauthorized message activity</h4>
            ...
            <h4 id="unethical-exploitative-and-malicious-activity">Unethical, exploitative, and malicious activity</h4>
            ...
            <h4 id="unauthorized-use-of-signalco-property">Unauthorized use of Signalco property</h4>
            <p>We prohibit the impersonation of Signalco, the representation of a significant business relationship with Signalco, or ownership of any Signalco property (including our Products and brand) for the purpose of fraudulently gaining service, custom, patronage, or user trust.</p>
