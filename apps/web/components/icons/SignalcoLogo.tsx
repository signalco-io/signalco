export default function SignalcoLogo({ width, height, theme }: { width?: number, height?: number, theme?: 'auto' | 'dark' | 'light' }) {
    if (typeof width === 'undefined' &&
        typeof height === 'undefined') {
        throw new Error('Either height or width must be provided to SignalcoLogo.');
    }

    const fixedWidth = width ?? (1255 / 1294) * (height ?? 0);
    const fixedHeight = height ?? (1294 / 1255) * (width ?? 0);
    ...
    return (
        <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
            ...
            <g
                ...
                transform="translate(0.000000,1294.000000) scale(0.100000,-0.100000)" stroke="none">
