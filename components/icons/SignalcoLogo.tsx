...
export default function SignalcoLogo({ priority, width, height, theme }: { priority?: boolean; width?: number; height?: number, theme?: "dark" | "light" }) {
    ...
    return (
        <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
            width={`${fixedWidth}pt`} height={`${fixedHeight}pt`} viewBox="0 0 1255.000000 1294.000000"
            preserveAspectRatio="xMidYMid meet"
            style={{ "--primary": theme === "dark" ? "#ffffff" : "#000000" }}>
            <defs>

            </defs>
            <g fill="var(--primary)" transform="translate(0.000000,1294.000000) scale(0.100000,-0.100000)" stroke="none">
