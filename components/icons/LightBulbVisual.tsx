...
const LightBulbVisual = (props: { state: boolean, theme: "dark" | "light", size: number }) => {
    const isActive = props.state;
    const bulbColor = isActive ? "#FFDD66" : "#c4c4c4";
    const edgeColor = props.theme === 'dark' ? "#333" : "#fff";
    const glossColor = props.theme === 'dark' ? "#fff" : "#000";
