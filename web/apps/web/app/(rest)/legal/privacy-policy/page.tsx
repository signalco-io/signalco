export default function PrivacyPolicy() {
    return (
        <article className="prose mx-auto mt-12 max-w-3xl">
            ...
            <p>This policy is effective as of 20 March 2022.</p>
            <p>Last updated: 20 March 2022</p>
            ...
            <h3 id="legitimate-reasons-for-processing-your-personal-information">Legitimate Reasons for Processing Your Personal Information</h3>
            ...
            <h3 id="how-long-we-keep-your-personal-information">How Long We Keep Your Personal Information</h3>
            ...
            <h2 id="disclosure-of-personal-information-to-third-parties">Disclosure of Personal Information to Third Parties</h2>
            ...
            <h2 id="international-transfers-of-personal-information">International Transfers of Personal Information</h2>
            <p>The personal information we collect is stored and/or processed in Netherlands, Germany, and Ireland, or where we or our partners, affiliates, and third-party providers maintain facilities.</p>
            ...
            <h2 id="your-rights-and-controlling-your-personal-information">Your Rights and Controlling Your Personal Information</h2>
            ...
            <h2 id="additional-disclosures-for-australian-privacy-act-compliance-au">Additional Disclosures for Australian Privacy Act Compliance (AU)</h2>
            <h3 id="international-transfers-of-personal-information-1">International Transfers of Personal Information</h3>
            ...
            <h2 id="additional-disclosures-for-general-data-protection-regulation-gdpr-compliance-eu">Additional Disclosures for General Data Protection Regulation (GDPR) Compliance (EU)</h2>
            <h3 id="data-controller--data-processor">Data Controller / Data Processor</h3>
            <p>The GDPR distinguishes between organisations that process personal information for their own purposes (known as “data controllers”) and organizations that process personal information on behalf of other organizations (known as “data processors”). We, Signalco, located at the address provided in our <a href="#contact-us">Contact Us</a> section, are a Data Controller and/or Processor with respect to the personal information you provide to us.</p>
            <h3 id="legal-bases-for-processing-your-personal-information">Legal Bases for Processing Your Personal Information</h3>
            ...
            <h4 id="consent-from-you">Consent From You</h4>
            ...
            <h4 id="performance-of-a-contract-or-transaction">Performance of a Contract or Transaction</h4>
            ...
            <h4 id="our-legitimate-interests">Our Legitimate Interests</h4>
            ...
            <h4 id="compliance-with-law">Compliance with Law</h4>
            ...
            <h3 id="international-transfers-outside-of-the-european-economic-area-eea">International Transfers Outside of the European Economic Area (EEA)</h3>
            ...
            <h3 id="your-rights-and-controlling-your-personal-information-1">Your Rights and Controlling Your Personal Information</h3>
            ...
            <h2 id="additional-disclosures-for-california-compliance-us">Additional Disclosures for California Compliance (US)</h2>
            ...
            <h3 id="cookies-and-pixels">Cookies and Pixels</h3>
            ...
            <h3 id="ccpa-permitted-financial-incentives">CCPA-permitted financial incentives</h3>
            ...
            <h3 id="california-notice-of-collection">California Notice of Collection</h3>
            ...
            <h3 id="right-to-know-and-delete">Right to Know and Delete</h3>
            ...
            <h3 id="shine-the-light">Shine the Light</h3>
