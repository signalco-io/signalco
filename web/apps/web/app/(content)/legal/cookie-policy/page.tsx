export default function CookiePolicy() {
    return (
        <article className="prose mx-auto mt-12 max-w-3xl">
            ...
            <p>If you don’t wish to accept cookies from us, you should instruct your browser to refuse cookies from <a href="https://www.signalco.io">https://www.signalco.io</a>. In such a case, we may be unable to provide you with some of your desired content and services.</p>
            ...
            <h3 id="types-of-cookies-and-how-we-use-them">Types of cookies and how we use them</h3>
            <h4 id="essential-cookies">Essential cookies</h4>
            ...
            <h4 id="performance-cookies">Performance cookies</h4>
